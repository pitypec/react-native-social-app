        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.userInfoSection}>
                <View style={styles.row}>
                    ...
                    <Text style={{color: '#777777', marginLeft: 20}}>Abuja, Nigeria</Text>
                </View>
                <View style={styles.row}>
                    <Icon name='phone' color='#777777' size={20}/>
                    <Text style={{color: '#777777', marginLeft: 20}}>+234805566778</Text>
                </View>
                <View style={styles.row}>
                    <Icon name='email' color='#777777' size={20}/>
                    <Text style={{color: '#777777', marginLeft: 20}}>adewumexemm1@gmail.com</Text>
                </View>
            </View>
